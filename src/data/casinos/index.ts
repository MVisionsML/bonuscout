...
export const casinos: Casino[] = [
  ...
  },
  {
    ...
    seoTitle: 'Blockspins Casino Bonus 2026 — 100% Crypto Bonus, 30x Wagering, BTC Tested',
    seoDescription: 'Blockspins crypto casino bonus: 100% first deposit match, provably fair games, 30x wagering — lowest in our comparison. Bitcoin withdrawals in 1-4h tested.',
    seoTitleDe: 'Blockspins Casino Bonus 2026 — 100% Krypto-Bonus, 30x Umsatz, BTC getestet',
    seoDescriptionDe: 'Blockspins Krypto-Casino-Bonus: 100% erste Einzahlung, provably-fair Spiele, 30-facher Umsatz — der niedrigste in unserem Vergleich. Bitcoin-Auszahlung in 1-4h getestet.',
  ...
  },
  {
    ...
    seoDescriptionDe: 'Jackpoty Casino Bonus im Test: €2.000 + 100 Freispiele Willkommensangebot bei fairem 35-fachen Umsatz. Bonus ohne Einzahlung, Umsatz-Guide und komplette Bonusbedingungen erklärt.',
    rating: 4.0, ratingMax: 5.0,
