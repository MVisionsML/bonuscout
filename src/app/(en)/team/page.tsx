...
export const metadata: Metadata = {
  ...
  description: 'About the BonusCout editorial team. How we organise our editorial evaluation work, the experience behind our reviews, and how to reach us.',
}
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              ...
              First, every review goes through more than one person — at minimum a researcher (licence verification, T&amp;C reading) and an
              editor (scoring sign-off). Second, we don&apos;t want to put fabricated personal credentials in front of readers. When a named
              author makes sense for a piece, we&apos;ll name them. Until then, the editorial team owns the byline.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#161820] border border-[#252830] rounded-xl p-6 mb-6">
        ...
        <div className="space-y-5 text-sm text-gray-400 leading-relaxed">
          <div>
            <div className="font-bold text-white mb-1">Editorial research and evaluation</div>
            <p>
              Owns the documentary evaluation of every operator on the site: licence-number verification against public registers, operator identity checks,
              reading bonus T&amp;Cs in full, recording payment methods from published cashier pages, and cross-checking third-party reputation indices
              (casino.guru, AskGamblers). Every score originates from this work.
            </p>
          </div>
          <div>
            ...
            <p>
              ...
              country restrictions. Calculates the realistic wagering burden of each bonus rather than the marketing-page value.
            </p>
          </div>
          <div>
      ...
      <section className="bg-[#0D0F14] border border-[#252830] rounded-xl p-6 mb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
          ...
          <Link href="/how-we-rate" className="text-[#F5A623] hover:underline">How We Evaluate Casinos →</Link>
