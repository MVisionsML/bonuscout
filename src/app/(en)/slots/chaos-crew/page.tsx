...
const faqs = [
  ...
  { q: 'Can I buy the Chaos Crew bonus directly?', a: 'Yes. Feature Buy costs 75x your current bet. RTP is unchanged at 96.31% — expected long-run return per €1 spent is around €0.96. Individual Feature Buy outcomes are Extreme-volatility: most single buys deliver modest returns, rare ones chain into the 10,000x maximum win territory.' },
