...
export const metadata: Metadata = {
  ...
  description: 'Full Book of Dead review 2026. Play\'n GO\'s Egyptian classic reviewed. 96.21% RTP, 5,000x max win, expanding symbols in free spins — definitive verdict.',
