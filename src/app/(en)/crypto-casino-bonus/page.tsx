...
export const metadata: Metadata = {
  title: 'Best Crypto Casino Bonus 2026 — Bitcoin & Ethereum Casinos Tested | BonusScout',
            ...
            <div key={casino.id} className="bg-[#161820] border border-orange-500/20 hover:border-orange-400/40 rounded-xl p-5 md:p-6 transition-all">
              <div className="flex items-start gap-4">
                ...
                <div className="hidden md:flex flex-col gap-2 flex-shrink-0">
                  ...
                  <Link href={`/reviews/${casino.slug}`} className="text-center text-sm text-gray-500 hover:text-[#F5A623]">
                    Read Review
                  </Link>
                </div>
              </div>
              <div className="md:hidden flex gap-3 mt-4 pt-4 border-t border-[#252830]">
                ...
                <Link href={`/reviews/${casino.slug}`} className="border border-[#252830] text-gray-400 text-sm px-4 py-2.5 rounded-lg hover:text-[#F5A623]">
                  Review
                </Link>
              </div>
            </div>
