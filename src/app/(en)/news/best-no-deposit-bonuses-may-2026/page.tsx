  ...
  return (
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <article className="prose prose-invert prose-sm max-w-none space-y-5 text-gray-400 leading-relaxed">
        ...
        <p>The second cut wagering on no deposit free spins from 40x to 30x. This is less dramatic in absolute terms but the threshold matters: 30x wagering on free-spin winnings means a €5 win requires €150 of turnover to clear, well within reasonable session play. The recalculated expected return on this offer improves meaningfully — the lower the wagering multiplier, the less expected variance eats before winnings are withdrawable.</p>
