...
export const metadata: Metadata = {
  ...
  description: 'Find casinos with the lowest wagering requirements in 2026. We rank every casino by wagering — from 0x to 30x. Evaluated against our published criteria.',
            ...
            <div key={casino.id} className="bg-[#161820] border border-[#252830] hover:border-[#F5A623]/30 rounded-xl p-5 transition-all">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col gap-2 flex-shrink-0">
                  ...
                  <Link href={casinoUrl(casino.slug)} className="text-center text-xs text-gray-500 hover:text-[#F5A623]">
                    Review
                  </Link>
                </div>
              </div>
