...
const faqs = [
  ...
  { q: 'Are crypto casinos safe?', a: 'Safety depends on licensing, not payment method. Crypto casinos with Curaçao or MGA licenses are generally safe. Always verify the license before depositing. Our documented list above includes only operators whose licences we have verified against the primary regulator register.' },
              ...
              <div key={casino.id} className="bg-[#161820] border border-orange-500/20 hover:border-orange-400/40 rounded-xl p-5 transition-all">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col gap-2 flex-shrink-0">
                    ...
                    <Link href={casinoUrl(casino.slug)} className="text-center text-xs text-gray-500 hover:text-[#F5A623]">Read Review</Link>
                  </div>
                </div>
              </div>
            ))}
