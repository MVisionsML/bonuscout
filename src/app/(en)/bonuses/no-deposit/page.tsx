...
export const metadata: Metadata = {
  title: 'No Deposit Casino Bonuses 2026 — Current State of the Market',
  description: 'The no-deposit bonus category has thinned across the market. Honest breakdown of why, what to look for, and welcome-bonus alternatives with free spins that work similarly.',
}

const faqs = [
  { q: 'Can I really withdraw winnings from a no deposit bonus?', a: 'Yes, but only after meeting the wagering requirements. There is also almost always a maximum withdrawal cap (often €50–€100) regardless of how much you actually won.' },
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="mb-10">
        ...
        <p className="text-gray-400 text-lg max-w-2xl mb-6">
          The no-deposit bonus category has thinned across the market — bonus-abuse automation, stricter KYC costs and shifting player expectations have pushed operators toward deposit-matched welcome packages. Below: what to look for, honest alternatives, and the full mechanics.
        </p>
        <div className="bg-[#161820] border border-[#252830] rounded-xl p-4 flex items-start gap-3">
          ...
          <p className="text-sm text-gray-400">
            <span className="text-white font-bold">Current inventory:</span> no dedicated no-deposit offers are verified in our index right now. Welcome packages with free spins (below) are the closest low-commitment alternative — same mechanics, similar wagering pattern.
          </p>
        </div>
      </div>
      ...
      {noDeposit.length > 0 ? (
        ...
        <div className="bg-[#161820] border border-[#252830] rounded-xl p-8 mb-10">
          <h2 className="text-lg font-black text-white mb-3">What to look for when a no-deposit offer does appear</h2>
          <ul className="text-sm text-gray-400 space-y-2 leading-relaxed list-disc pl-5">
            <li><span className="text-white font-medium">Wagering under 40x</span> — anything higher rarely converts to real money after variance.</li>
            <li><span className="text-white font-medium">Max-withdrawal cap €100+</span> — €50 caps limit the offer to entertainment rather than value.</li>
            <li><span className="text-white font-medium">Per-spin stake €0.20+</span> — €0.10 spins have low expected value; €0.20+ meaningfully raises returns.</li>
            <li><span className="text-white font-medium">Reputable licensor</span> — MGA, UKGC, or a modern Curaçao GCB licence (not a corporate registration).</li>
            <li><span className="text-white font-medium">Clear T&amp;C exclusions</span> — some offers exclude popular slots or live dealer; check before claiming.</li>
          </ul>
        </div>
      )}
