...
// Styles MDX content (from /articles/* page.mdx files) to match BonusScout's dark theme.
// Component overrides here apply globally to all MDX rendering in the app.
